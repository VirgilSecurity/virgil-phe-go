...
func TestHashZVector1(t *testing.T) {
	...
	chlng := "36781186916061460506528622976524495561962342900312546145999635825153911863126"
...
func TestHashZVector2(t *testing.T) {
	...
	chlng := "43706665579225183909865134322239684236977397686025563957189888324317762848330"
...
func TestSimpleHashZ(t *testing.T) {
	require.Equal(t, "39267966338981738513071510436104613443947462332368659586595660050151396534561", hashZ(proofOk, curveG).String())
}
